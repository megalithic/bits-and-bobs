...
# (NEO)VIM
# -----------------------------------------------------------------------------
alias updatenvim="brew update; pip3 install --upgrade neovim; pip install --upgrade neovim; pip3 install --upgrade pip; chruby system; gem install neovim; nvim +PlugUpgrade +qall; nvim +PlugUpdate +qall; nvim +UpdateRemotePlugins +qall; cd -; wget https://raw.githubusercontent.com/pangloss/vim-javascript/master/indent/javascript.vim -O ~/.config/nvim/after/indent/javascript.vim; brew outdated"
