...
hotkey.bind('cmd', 'f4', function() utils.toggleApp('ctrlla.Polymail') end)
hotkey.bind(mashShift, '4', function() utils.toggleApp('com.nylas.nylas-mail') end)
hotkey.bind(ctrlShift, '4', function() utils.toggleApp('ctrlla.Polymail') end)
